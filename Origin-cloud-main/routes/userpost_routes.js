...
//    console.log(new_user);
   res.render('user-timeline',{User:new_user,posts:user_post})
...
router.post("/commentpost/:id", authenticate ,function(req,res){
...
router.post("/answerQuest/:id", authenticate ,function(req,res){
